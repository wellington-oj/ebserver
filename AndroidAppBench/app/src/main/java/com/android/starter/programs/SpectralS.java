...
public class SpectralS
{

    private static final NumberFormat formatter = new DecimalFormat("#.000000000");

    public void runCode(final int n, FileOutputStream writer) throws InterruptedException, IOException {
        writer.write((formatter.format(new SpectralS().Approximate(n))).getBytes());
    }
