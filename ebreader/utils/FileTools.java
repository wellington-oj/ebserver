...
public class FileTools {
    ...
    public static String getFilePath(Commands type, String path, AppName appName, 
                                    String device, ExpData benchmark, int fileNumber) {
    ...
    private static String pathToFolder(String path, AppName appName, 
                                    String device, ExpData benchmark){
        return  path + appName.toString() + "/" + device + "/" + 
                benchmark.toString() +"-"+ benchmark.getWorkload() + "/";
    }

    public static void outputCSV(String device, List<Metrics> metrics, ExpData input, 
                                AppName framework,
